...
There are 2 types of range systems in bioinformatics: - *0-based* coordinate systems with *half closed, half open intervals*
...
- 1-base" 'end - start + 1'
	- Note: 1-base systems lowester possible width is 1
...
## Strand
Most range formats (except BLAST) specify range cooridinates *on the forward strand* of the reference sequence 
...
*bioconductor* - an open sorce software project that creates R bioinformatitcs packages and serves as as repository for them.  Common packages:
...
# create ranges by specifying width with start or end positoin
